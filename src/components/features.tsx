...
export default function Features() {
  ...
  const [baseColor, setBaseColor] = useState<[number, number, number]>([0.1608, 0.6627, 0.8392]); // #29A9D6 in RGB normalized
  ...
  useEffect(() => {
    ...
    setGlowColor([0.1608, 0.6627, 0.8392]); // #29A9D6
          ...
          <div className="cursor-none">
            <div className="grid grid-cols-12 gap-4 justify-center">
              ...
              <motion.div
                ...
                whileHover={{
                  scale: 1.02,
                  borderColor: "rgba(41, 169, 214, 0.6)",
                  boxShadow: "0 0 30px rgba(41, 169, 214, 0.2)",
                }}
              ...
              <motion.div
                ...
                whileHover={{
                  scale: 1.02,
                  borderColor: "rgba(41, 169, 214, 0.5)",
                  boxShadow: "0 0 30px rgba(41, 169, 214, 0.2)",
                }}
                style={{ transition: "all 0s ease-in-out" }}
              >
              ...
              <motion.div
                ...
                whileHover={{
                  rotateY: 5,
                  rotateX: 2,
                  boxShadow: "0 20px 40px rgba(41, 169, 214, 0.3)",
                  borderColor: "rgba(41, 169, 214, 0.6)",
                }}
                style={{ transition: "all 0s ease-in-out" }}
              >
